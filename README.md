...
docker run -d  -e ZKEY=/app/binaries/zkLogin-main.zkey  -e WITNESS_BINARIES=/app/binaries  -v $HOME/data/zklogin-ceremony-contributions/zkLogin-main.zkey:/app/binaries/zkLogin-main.zkey -p 5000:8080  mysten/zklogin:prover-stable
...
```
docker run -d  --add-host=host.docker.internal:host-gateway  -e PROVER_URI='http://host.docker.internal:5000/input'  -e NODE_ENV=production  -e DEBUG=zkLogin:info,jwks -p 5001:8080  mysten/zklogin:prover-fe-stable
